...
class CompositeBlockTest {
    ...
    @Test void coverIsNotTheStructuralSource() {
        ...
        parts.add(Blocks.MOSS_CARPET.defaultBlockState(), LocalTransform.IDENTITY, 0);
    ...
    @Test void onlyPartsRestingOnTheCoverFollowItsBreak() {
        var carpet = new PartInstance(0, Blocks.MOSS_CARPET.defaultBlockState(), LocalTransform.IDENTITY, 0);
