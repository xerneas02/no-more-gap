...
class FixedPointTest {
    ...
    @Test void validatesRangeAndArithmetic() {
        ...
        assertEquals(-368, FixedPoint.fromDouble(-1.4375).units());
        assertEquals(FixedPoint.MIN_UNITS,
                FixedPoint.fromDouble((double) FixedPoint.MIN_UNITS / 256).units());
        assertThrows(IllegalArgumentException.class, () -> new FixedPoint(FixedPoint.MIN_UNITS - 1));
